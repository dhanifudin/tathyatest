...
/**
 * Hand-written reference suite for the React/Inertia case study — the human baseline that
 * `tt eval` compares the generated suite against (Family E / RQ5). Mirrors the Blade baseline but
 * asserts against the SPA's rendered DOM. Runs under the same playwright.config as the generated
 * suite.
 */
